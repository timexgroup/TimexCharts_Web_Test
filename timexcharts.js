...
var StepCountBarChart = /*#__PURE__*/function () {
  function StepCountBarChart(_ctx) {
    ...
    StepCountBarChart_defineProperty(this, "customCursorTrackerHandler", function (chart, args, options) {
    ...
    StepCountBarChart_defineProperty(this, "customToolTipHandler", function (chart, args, options) {
      if (options.enabled === true) {
        var ctx = chart.ctx;
        var canvas = chart.canvas;
        var xAxis = chart.scales['x'];
  ...
  StepCountBarChart_createClass(StepCountBarChart, [{
    ...
    value: function addCustomPlugins() {
      Chart.register({
    ...
    key: "customXAxisBackgroundHandler",
    value: function customXAxisBackgroundHandler(chart, args, options) {
      var ctx = chart.ctx;
      var xAxis = chart.scales['x'];
      ctx.save();
