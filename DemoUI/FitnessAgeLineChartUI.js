...
*               02/29/2024 JRD - Fix accept negative value for age and for 
*                                   threshold
*
*******************************************************************************/
...
class FitnessAgeLineChartUI {
    ...
    addAgeClick() {
        ...
        if (hrValue === '' || dateValue === '' || parseInt(hrValue) < 0) {
    ...
    setThresholdsClick() {
        ...
        if (lowInput === '' || moderateInput === '' || highInput === '' || parseInt(lowInput) < 0) {
            alert('Please enter correct values.');
        } else {
    ...
    updateList() {
        ...
        this.fitnessAgeLineChart.fitnessAgeData.forEach((dataPoint, index) => {
            ...
            indexCell.style.paddingRight = '50px';
            ...
            dateCell.style.paddingRight = '50px';
